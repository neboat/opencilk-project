...
// CHECK: %[[START:.+]] = load i64, ptr
// CHECK-NEXT: store i64 %[[START]], ptr %[[INIT:.+]], align 8
// CHECK-NEXT: %[[END:.+]] = load i64, ptr
// CHECK-NEXT: store i64 %[[END]], ptr %[[LIMIT:.+]], align 8
// CHECK-NEXT: %[[INITCMPINIT:.+]] = load i64, ptr %[[INIT]]
// CHECK-NEXT: %[[INITCMPLIMIT:.+]] = load i64, ptr %[[LIMIT]]
// CHECK-NEXT: %[[INITCMP:.+]] = icmp ult i64 %[[INITCMPINIT]], %[[INITCMPLIMIT]]
// CHECK-NEXT: br i1 %[[INITCMP]], label %[[PFORPH:.+]], label %[[PFOREND:.+]]

// CHECK: [[PFORPH]]:
// CHECK-NEXT: store i64 0, ptr %[[BEGIN:.+]], align 8
...
// CHECK: store i64 %[[ITERADD]], ptr %[[ITERSLOT]]

// CHECK: [[PFORINC]]:
// CHECK-NEXT: %[[INCBEGIN:.+]] = load i64, ptr %[[BEGIN]]
// CHECK-NEXT: %[[INC:.+]] = add i64 %[[INCBEGIN]], 1
// CHECK-NEXT: store i64 %[[INC]], ptr %[[BEGIN]]
// CHECK-NEXT: %[[CONDBEGIN:.+]] = load i64, ptr %[[BEGIN]]
// CHECK-NEXT: %[[CONDEND:.+]] = load i64, ptr %[[END]]
...
// CHECK-NEXT: %[[STRIDE:.+]] = load i64, ptr %[[STRIDEADDR:.+]], align 8
...
// CHECK: %[[INITITER:.+]] = load i64, ptr %[[INIT]]
// CHECK-NEXT: %[[BEGINITER:.+]] = load i64, ptr %[[BEGIN]]
// CHECK-NEXT: %[[STRIDEITER:.+]] = load i64, ptr %[[STRIDEADDR]]
