...
// CHECK: define {{.*}}void @parfor_novec(ptr noalias noundef %y, ptr noalias noundef %x, double noundef %a, i32 noundef %n)
// CHECK: !llvm.loop [[LOOPID1:![0-9]+]]

// CHECK: define {{.*}}void @parfor_unroll_vec(ptr noalias noundef %y, ptr noalias noundef %x, double noundef %a, i32 noundef %n)
