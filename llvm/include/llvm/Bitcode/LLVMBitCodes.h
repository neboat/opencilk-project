...
enum AttributeKindCodes {
  ...
  ATTR_KIND_STRAND_NO_ALIAS = 99,
  ATTR_KIND_INJECTIVE = 100,
  ATTR_KIND_HYPER_VIEW = 101,
  ATTR_KIND_HYPER_TOKEN = 102,
  ATTR_KIND_REDUCER_REGISTER = 103,
  ATTR_KIND_REDUCER_UNREGISTER = 104,
};
