...
enum AttributeKindCodes {
  ...
  ATTR_KIND_STRAND_NO_ALIAS = 88,
  ATTR_KIND_INJECTIVE = 89,
  ATTR_KIND_HYPER_VIEW = 90,
  ATTR_KIND_HYPER_TOKEN = 91,
  ATTR_KIND_REDUCER_REGISTER = 92,
  ATTR_KIND_REDUCER_UNREGISTER = 93
};
