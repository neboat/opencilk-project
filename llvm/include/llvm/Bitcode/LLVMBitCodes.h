...
enum AttributeKindCodes {
  ...
  ATTR_KIND_STRAND_PURE = 105,
  ATTR_KIND_STRAND_NO_ALIAS = 106,
  ATTR_KIND_INJECTIVE = 107,
  ATTR_KIND_HYPER_VIEW = 108,
  ATTR_KIND_REDUCER_REGISTER = 109,
  ATTR_KIND_REDUCER_UNREGISTER = 110,
};
