...
=======
      ...
      (void)llvm::createSelectOptimizePass();
      (void) llvm::createTaskSimplifyPass();
>>>>>>> eb432d88f868 ([LoopStripMine] Initial commit of a pass to stripmine Tapir loops.  The pass seems to work on the Cilk application benchmark suite.  The cost analysis in the pass is rudimentary, and some general functionality is missing, e.g., inserting a prolog loop instead of an epilog loop and making the detach of the stripmined loop optional.)
