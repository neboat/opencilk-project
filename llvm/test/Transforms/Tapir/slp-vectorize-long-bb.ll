...
; CHECK: and <4 x i64> %{{.+}}, splat (i64 -8589934591)
; CHECK: load <4 x i64>, ptr
; CHECK-NEXT: and <4 x i64> %{{.+}}, splat (i64 8589934590)
...
; CHECK-NEXT: and <4 x i64> %{{.+}}, splat (i64 -8589934591)
...
; CHECK-NEXT: and <4 x i64> %{{.+}}, splat (i64 -562941363617791)
; CHECK-NEXT: and <4 x i64>
; CHECK-NEXT: or disjoint <4 x i64>
; CHECK-NEXT: store <4 x i64>
...
; CHECK-NEXT: and <4 x i64> %{{.+}}, splat (i64 -143554428589179391)
; CHECK-NEXT: and <4 x i64>
; CHECK-NEXT: or disjoint <4 x i64>
; CHECK-NEXT: store <4 x i64>
...
; CHECK-NEXT: and <4 x i64> %{{.+}}, splat (i64 -2170205185142300191)
; CHECK-NEXT: and <4 x i64>
; CHECK-NEXT: or disjoint <4 x i64>
; CHECK-NEXT: store <4 x i64>
